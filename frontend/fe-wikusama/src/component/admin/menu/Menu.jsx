...
function SearchInput({ onSearch, onClearSearch }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
      {/* <input
        type="text"
        placeholder="Search by nama menu"
        className="w-full sm:w-32 py-2 pl-10 ml-10 mt-0 text-sm rounded-md sm:w-auto focus:outline-none text-white bg-gray-200"
        value={searchTerm}
        onChange={(e) => setSearchTerm(e.target.value)}
      />
      <button
        type="button"
        className=" text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-green-500 hover:bg-green-800 focus:ring-green-900"
  ...
  return (
    <div>
      <div className="my-8 mx-16 ">
        <div>
          <a href="add_menu">
            <button type="button" className="mb-1 text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center bg-green-500 hover:bg-green-800 focus:ring-green-900">
              Tambahkan Menu
            </button>
          </a>
        </div>
